                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            ...
                            <h2 class="bienvenido">Bienvenido <?php echo $nombre ?></h2>
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                    ...
                                    <div class="select-button">
                                        <a href="bolsa.php" class="primary-btn view-card">VIEW CARD</a>
                        ...
                        ?>
                          <div class="product-item">
                                <div class="pi-pic">
                                    ...
                                    <ul>
                                        <li class="w-icon active"><a href="Accion.php?action=addToCart&id=<?php echo $row["id"]; ?>"><i class="icon_bag_alt"></i></a></i></a></li>
    ...
    <section class="deal-of-week set-bg spad" data-setbg="<?php echo $row["image"]?>">
        <div class="container">
            <div class="col-lg-6 text-center">
                ...
                <a href="Accion.php?action=addToCart&id=<?php echo $row["id"]; ?>" class="primary-btn">Compra ahora</a>
            </div>
        </div>
    </section>                  
    <?php     }
